...
public class ArccosTest {
    ...
    public void resultValues() {
        double[] points = new double[] { -1, -0.97, -0.83, -0.753, -0.6, -0.51, -0.43, -0.37, -0.22, -0.156, 0, 0.156,
                0.22, 0.37, 0.43, 0.51, 0.6, 0.753, 0.83, 0.97, 1 };
        double[] results = new double[] { 3.141592653589793, 2.896027136074501, 2.549904011163249, 2.4234057184577593,
                2.214297435588181, 2.1059811170704963, 2.0152891037307157, 1.9498053474908474, 1.792610797291691,
                1.7274360940808284, 1.5707963267948966, 1.414156559509, 1.3489818562981022, 1.191787306098946,
                1.1263035498590777, 1.0356115365192968, 0.9272952180016123, 0.7181869351320339, 0.5916886424265441,
                0.24556551751529213, 0 };
